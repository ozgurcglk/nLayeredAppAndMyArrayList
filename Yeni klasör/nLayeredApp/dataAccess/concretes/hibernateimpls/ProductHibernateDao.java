...
public class ProductHibernateDao implements ProductDao {
	...
	public void add(Product addProduct) {
		...
		System.out.println(addProduct.getName()+" has been added via Hibernate!");
	}
	...
	public void update(Product updateProduct) {
		for ( Product product : products) {
			if(product.getId() == updateProduct.getId()) {
				...
				System.out.println(product.getId()+" has been updated via Hibernate!");
				return;
			}
	...
	public void delete(Product deleteProduct) {
		for (Product product : products) {
			if(product.getId() == deleteProduct.getId()) {
				System.out.println(product.getId()+ " has been removed via Hibernate !");
